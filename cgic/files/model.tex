...
Nylon classical guitar strings have very different physical properties than those of steel strings. When fresh strings are brought up to the required tension for the first time, they are stretched by a distance $\Delta L$ that varies from 8~cm (for the first $E_4$ string) to 2~cm (for the sixth $E_2$ string). After a few minutes, the string must be re-tensioned because it has experienced viscoelastic relaxation and has gone flat by at least a half-step~\cite{ref:blanc1996nvb,ref:lynchaird2017mpn,ref:lynchaird2018cmp}. This process continues for several hours until the strings begin to ``settle'' and remain properly tuned for longer periods; after about 10~hours, they will remain at the proper frequencies for an hour provided that the temperature in the room doesn't change.~\cite{ref:blanc1996nvb,ref:lynchaird2017mpn}.
\begin{equation} \label{eqn:youngs_mod_t_0_def}

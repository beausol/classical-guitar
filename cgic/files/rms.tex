...
In \sct{model}, we determined that --- for the purposes of estimating the values of the setbacks --- $W_n$ could be represented accurately by
\begin{equation} \label{eqn:w_n_approx}
  W_n \approx \frac{\Delta N - \left(\gamma_n - 1\right) \Delta S}{X_0}\, .
\end{equation}
Furthermore, we discovered that $Z_n$ does not depend to second order on either $\Delta S$ or $\Delta N$. Therefore, the components of the gradient of $\chi^2$ are
...
% \begin{subequations}
%   \begin{align}
%     \Delta S &= \left(B_0 + \frac{\kappa}{2}\, \frac{\sigma_0\, \overline{Q}_1 - \sigma_1\, \overline{Q}_0}{\sigma_0\, \sigma_2 - \sigma_1^2} \right) X_0\, , \nd \\
%     \Delta N &= -\frac{\kappa}{2}\, \frac{\sigma_2\, \overline{Q}_0 - \sigma_1\, \overline{Q}_1}{\sigma_0\, \sigma_2 - \sigma_1^2}\, X_0\, .
%   \end{align}
% \end{subequations}

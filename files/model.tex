...
f_{m} = \frac{m}{2\, L}\, \sqrt{\frac{T}{\mu}} \left[ 1 + 2 B + 4 \left(1 + \frac{\pi^2\, m^2}{8}\right) B \right]\, .
 \end{equation}
...
Incorporating all of these effects, the total frequency shift is given by

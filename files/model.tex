...
f_{m n} = \frac{1}{2\, L_n}\, \sqrt{\frac{T_n}{\mu_n}} \left[ 1 + B_n + \left(1 + \frac{\pi^2\, m^2}{8}\right) B_n^2 \right]\, ,
 \end{equation}
 \begin{equation} \label{eqn:f_n_stiff}
f_n = \frac{1}{2\, L_n}\, \sqrt{\frac{T_n}{\mu_n}} \left[ 1 + B_n + \left(1 + \frac{\pi^2}{8}\right) B_n^2 \right]\, ,
 \end{equation}
 \begin{equation} \label{eqn:f_m_open}
f_m = \frac{1}{2\, L_0}\, \sqrt{\frac{T_0}{\mu_0}} \left[ 1 + B_0 + \left(1 + \frac{\pi^2\, m^2}{8}\right) B_0^2 \right]\, ,
 \end{equation}

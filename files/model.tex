...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.8\textwidth}
      ...
      \label{fig:bnu_test}
  \end{subfigure}
  \caption{\label{fig:stiffness_test} A comparison of exact and approximate expressions for (a) bending stiffness, given by \eqn{bg_n_def}, and (b) the corresponding frequency shift, given by \eqn{dnu_bn}. Here the guitar has $b = 1.0$~mm, $c = 3.5$~mm, $\Delta S = 1.75$~mm, $\Delta N = -0.35$~mm, $\kappa = 100$, and a scale length of 650~mm.}
\end{figure}

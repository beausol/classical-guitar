...
\red{Here's the old \emph{wrong} equation:}
 \begin{equation}
f_{m n} = \frac{m}{2\, L_n}\, \sqrt{\frac{T_n}{\mu_n}} \left[ 1 + 2 B_n + 4 \left(1 + \frac{\pi^2\, m^2}{8}\right) B_n^2 \right]\, ,
 \end{equation}
\red{Here's the new equation, from \app{freq}, applied to fret $n$:}

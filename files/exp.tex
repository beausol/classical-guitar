...
\sqrt{\kappa} = \frac{-\beta + \sqrt{\beta^2 + 4\, \alpha\, \xi}}{2\, \alpha}\, ,
 \end{equation}
where we have chosen the positive root to ensure that $\sqrt{\kappa} > 0$.
